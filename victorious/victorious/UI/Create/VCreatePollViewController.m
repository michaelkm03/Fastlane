...
//    [questionTextField pinEdge:NSLayoutAttributeTop toEdge:NSLayoutAttributeBottom ofItem:self.topLayoutGuide];
    ...
    self.questionView.backgroundColor = [[VThemeManager sharedThemeManager] themedColorForKeyPath:@"theme.color.post.poll.questions.border"];
...
//    [questionsView addConstraint:[NSLayoutConstraint constraintWithItem:rightAnswerTextField attribute:NSLayoutAttributeLeft relatedBy:NSLayoutRelationEqual toItem:questionsView attribute:NSLayoutAttributeCenterX multiplier:1 constant:0]];
    ...
    UIImage* newImage = [self.leftRemoveButton.imageView.image imageWithRenderingMode:UIImageRenderingModeAlwaysTemplate];
    [self.leftRemoveButton setImage:newImage forState:UIControlStateNormal];
    self.leftRemoveButton.tintColor = [[VThemeManager sharedThemeManager] themedColorForKeyPath:@"theme.color.post.media.remove"];
    [self.leftPreviewImageView addSubview: self.leftRemoveButton];
    ...
    [self.rightPreviewImageView addSubview: self.rightRemoveButton];
