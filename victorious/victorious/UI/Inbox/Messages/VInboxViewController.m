...
- (void)viewWillAppear:(BOOL)animated
{
    ...
    self.tableView.scrollIndicatorInsets = UIEdgeInsetsMake(- 2.0f - self.tableView.estimatedRowHeight + CGRectGetHeight(self.navigationController.navigationBar.bounds), 0, 0, 0);
}
