...
/**
 *  Typedef for player item ready callback.
 */
typedef void(^VVideoFrameRateCompositionPlayerItemReadyCallback)(NSError *error, AVPlayerItem *playerItem);
 ...
 */
@property (nonatomic, copy) VVideoFrameRateCompositionPlayerItemReadyCallback onPlayerItemReady;
