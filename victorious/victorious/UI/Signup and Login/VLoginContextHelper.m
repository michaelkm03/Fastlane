...
- (NSString *)textForContext:(VLoginContextType)context
{
    switch ( context )
    {
        ...
        case VLoginContenxtVoteSequence:
            return @"These emojis are amazing, right?\nCreate an account first and then send some love!";
            
        case VLoginContenxtFollowHashtag:
            return @"You can follow this hashtag and other trending hashtags in the app.\nSimply create an account!";
            
        case VLoginContenxtFollowUser:
            return @"You can follow this user and see all of their latest posts.\nSimply create an account!";
            
        case VLoginContenxtViewProfile:
            return @"Let other users in the community know who you are!\nSign up below to create an account.";
