...
class MediaSearchViewController: UIViewController {
    ...
    let searchDataSource = MediaSearchDataSource()
    ...
    func updateViewWithResult( result: MediaSearchDataSource.ChangeResult? ) {
...
private extension UICollectionView {
    ...
    func applyDataSourceChanges( result: MediaSearchDataSource.ChangeResult ) {
