...
struct StreamCellAligner {
    ...
    let cell: ChatStreamCell
    
    init(cell: ChatStreamCell) {
        self.cell = cell
    }
...
class ChatStreamCell: UICollectionViewCell {
    
    static var suggestedReuseIdentifier = "ChatStreamCell"
