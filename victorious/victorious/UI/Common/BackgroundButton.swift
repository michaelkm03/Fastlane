...
/// A button that properly displays a background color when setting a background color.
class BackgroundButton: UIButton {
    private struct Constants {
        static let addedWidth = CGFloat(20.0)
        static let height = CGFloat(30.0)
        static let cornerRadius = CGFloat(6.0)
        static let defaultFont = UIFont.systemFontOfSize(18.0, weight: UIFontWeightSemibold)
