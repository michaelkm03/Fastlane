...
- (void)onDoneLoadingWithTemplateConfiguration:(NSDictionary *)templateConfiguration
{
    ...
    {
#warning TESTING
        templateConfiguration = [NSJSONSerialization JSONObjectWithData:[NSData dataWithContentsOfFile:[[NSBundle bundleForClass:[self class]] pathForResource:@"test" ofType:@"json"]] options:0 error:nil][@"payload"];
