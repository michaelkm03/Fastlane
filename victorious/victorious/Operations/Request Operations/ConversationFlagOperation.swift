//
//  ConversationFlagOperation.swift
//  victorious
//
...
class ConversationFlagOperation: FetcherOperation {
    ...
    init(conversationID: Int, mostRecentMessageID: Int) {
        ...
        let remoteOperation = ConversationFlagRemoteOperation(conversationID: conversationID, mostRecentMessageID: mostRecentMessageID)
