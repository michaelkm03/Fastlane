...
#define FORCE_SIMULATE_STOREKIT             1
...
#warning VPurchaseManager is simulating one or more StoreKit interactions
#endif

#if SIMULATE_NO_RESTORED_PRODUCTS || SIMULATE_PURCHASE_ERROR || SIMULATE_FETCH_PRODUCTS_ERROR || SIMULATE_RESTORE_PURCHASE_ERROR
