                                                              ...
                                                              failBlock:(FailBlock)fail
{
    ...
    {
        path = [path stringByAppendingFormat:@"/0/%u/%lu", status.pagesLoaded + 1, (unsigned long)status.itemsPerPage];
    }
                                                             ...
                                                             failBlock:(FailBlock)fail
{
    ...
    if (status.pagesLoaded) //only add page to the path if we've looked it up before.
    {
        path = [path stringByAppendingFormat:@"/%u/%lu", status.pagesLoaded + 1, (unsigned long)status.itemsPerPage];
    }
