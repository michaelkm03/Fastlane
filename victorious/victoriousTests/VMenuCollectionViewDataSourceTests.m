...
- (void)setUp
{
    ...
    self.sectionOneItem = [[VNavigationMenuItem alloc] initWithTitle:@"One" identifier:@"One" icon:nil selectedIcon:nil destination:sectionOneVC];
    self.sectionTwoItem = [[VNavigationMenuItem alloc] initWithTitle:@"Two" identifier:@"Two" icon:nil selectedIcon:nil destination:sectionTwoVC];
