...
- (void)setUp
{
    ...
    self.sectionOneItem = [[VNavigationMenuItem alloc] initWithLabel:@"One" icon:nil destination:sectionOneVC];
    self.sectionTwoItem = [[VNavigationMenuItem alloc] initWithLabel:@"Two" icon:nil destination:sectionTwoVC];
