...
module VAMS
  class ClientTest < Minitest::Test
    def test_authentication
      ...
      stub_request(:post, "https://staging.getvictorious.com/api/login?email=#{env.username}&password=#{env.password}").
      ...
      received_token, user_id = Client.authenticate(date: date)
