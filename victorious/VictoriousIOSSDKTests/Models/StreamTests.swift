...
class StreamTests: XCTestCase {
    ...
    func testValid() {
        ...
        XCTAssertEqual( stream.apiPath, "http://dev.getvictorious.com/api/sequence/detail_list_by_stream_with_marquee/13396/0/%%PAGE_NUM%%/%%ITEMS_PER_PAGE%%" )
