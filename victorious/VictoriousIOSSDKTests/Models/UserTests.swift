...
class UserTests: XCTestCase {
    ...
    func testJSONParsing() {
        ...
        if user.avatar.count == 2 {
            XCTAssertEqual(user.avatar[0].url, NSURL(string: "https://d36dd6wez3mcdh.cloudfront.net/67ad37b710f11cea3c52feec037bcf10/80x80.jpg"))
            XCTAssertEqual(user.avatar[0].size, CGSize(width: 80, height: 80))
            XCTAssertEqual(user.avatar[1].url, NSURL(string: "https://d36dd6wez3mcdh.cloudfront.net/67ad37b710f11cea3c52feec037bcf10/100x100.jpg"))
            XCTAssertEqual(user.avatar[1].size, CGSize(width: 100, height: 100))
        } else {
