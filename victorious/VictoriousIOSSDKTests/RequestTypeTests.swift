...
class RequestTypeTests: XCTestCase {
    ...
    func testSuccessfulExecution() {
        ...
        let _ = stubRequest("GET", "http://www.example.com/" as NSString).andReturn(200)?.withBody(expectedResponse as NSString)
        ...
        let _ = mockRequest.execute(baseURL: URL(string: "http://this.doesnt.matter/")!, requestContext: mockRequestContext, authenticationContext: nil) { (actualResult, error) in
            XCTAssertNil(error)
    ...
    func testNetworkFailure() {
        ...
        stubRequest("GET", mockRequestURL.absoluteString as NSString).andFailWithError(expectedError)
        ...
        let callbackExpectation = expectation(description: "callback")
        let _ = mockRequest.execute(baseURL: URL(string: "http://this.doesnt.matter/")!, requestContext: mockRequestContext, authenticationContext: nil) { (result, actualError) in
    ...
    func testParsingFailure() {
        ...
        let _ = stubRequest("GET", mockRequestURL.absoluteString as NSString).andReturn(200)?.withBody(expectedResponse as NSString)
        ...
        let callbackExpectation = expectation(description: "callback")
        let _  = mockRequest.execute(baseURL: URL(string: "http://this.doesnt.matter/")!, requestContext: mockRequestContext, authenticationContext: nil) { (actualResult, actualError) in
    ...
    func testProperApplicationOfBaseURL() {
        ...
        let _ = stubRequest("GET", "http://api.example.com/abc/123" as NSString).andReturn(200)?.withBody("test" as NSString)
        
        let _ = request.execute(baseURL: URL(string: "http://api.example.com/")!, requestContext: mockRequestContext, authenticationContext: nil)
        waitForExpectations(timeout: 2, handler: nil)
    }
    ...
    func testBaseURLNotAppliedWhenNotNecessary() {
        ...
        let _ = stubRequest("GET", mockURLString as NSString).andReturn(200)?.withBody("test" as NSString)
    ...
    func testJSONParsing() {
        ...
        let _ = stubRequest("GET", "http://api.example.com/api/test" as NSString).andReturn(200)?.withHeader("Content-Type", "application/json")?.withBody(mockJSONData as NSData)
    ...
    func testAuthenticationHeader() {
        var expectedURLRequest = URLRequest(url: URL(string: "http://api.example.com/api/test2")!)
        ...
        let _ = stubRequest("GET", "http://api.example.com/api/test2" as NSString).andReturn(200)
        
        let _ = request.execute(baseURL: URL(string: "http://api.example.com/")!, requestContext: mockRequestContext, authenticationContext: mockAuthenticationContext)
        waitForExpectations(timeout: 2, handler: nil)
    }
    
    func testAuthenticationHeaderWithNoAuthenticationContext() {
        var expectedURLRequest = URLRequest(url: URL(string: "http://api.example.com/api/test3")!)
        ...
        let _ = stubRequest("GET", "http://api.example.com/api/test3" as NSString).andReturn(200)
    ...
    func testOtherHeaders() {
        ...
        let _ = stubRequest("GET", "http://api.example.com/api/test4" as NSString).andReturn(200)
    ...
    func testRequestIsOriginal() {
        ...
        let _ = stubRequest("GET", mockURLRequest.url!.absoluteString as NSString).andReturn(200)?.withBody("body" as NSString)
    ...
    func testAPIErrorParsing() {
        ...
        let mockJSONData = try! JSONSerialization.data(withJSONObject: mockJSONDictionary, options: [])
        let _ = stubRequest("GET", mockRequestURL.absoluteString as NSString).andReturn(200)?.withHeader("Content-Type", "application/json")?.withBody(mockJSONData as NSData)
        let mockRequest = MockRequest(requestURL: mockRequestURL) { (_) -> Int in
            return 2
        }
