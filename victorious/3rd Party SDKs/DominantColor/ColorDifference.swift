...
func CIE2000SquaredColorDifference(
    ...
    let subtractors = 0.20 * cos(GLKMathDegreesToRadians(4 * Hbp - 63)) + 0.17 * cos(GLKMathDegreesToRadians(Hbp - 30))
    let additors = 0.24 * cos(GLKMathDegreesToRadians(2 * Hbp)) + 0.32 * cos(GLKMathDegreesToRadians(3 * Hbp + 6))
    let T = 1 - subtractors + additors
