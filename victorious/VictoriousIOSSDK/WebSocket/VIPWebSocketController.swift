...
public class VIPWebSocketController: WebSocketDelegate, ForumNetworkSourceWebSocket, WebSocketEventDecoder, WebSocketPongDelegate {
    ...
    /// The `VIPWebSocketController` has no `nextSender` since it's the last link in the chain.
    /// Messages reaching `VIPWebSocketController` will be piped over the WebSocket.
